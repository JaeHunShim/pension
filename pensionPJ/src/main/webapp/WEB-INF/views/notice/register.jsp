...
<div class="title">
	...
	<form method='post' name='writeF'id="writeF" action="/notice/register">
		<style type="text/css">
    	...
    	<div class="zz_new_write contenter">
    		<table width="100%" border="0" cellspacing="0" cellpadding="0" class="zz_write_table">
            	...
            	<td>
            		...
            		<input type='radio' name='privacy' id='privacy' value='n' checked in_lng='2' in_ttl='비밀글'  in_mode='y' in_type='02' class='iptborder'  style='border:0'> n</td>
          		</tr>
				<tr>
            		<th scope="row">성명</th>
            		<td>
