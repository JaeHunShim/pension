...
<meta name="naver-site-verification"
	content="4be275fbcf12fb470711cb98c210da2e3861002e" />
<meta name="description"
	content="충남 보령 무창포펜션, 무창포 해수욕장, 가족펜션, 객실개별바베큐, 수영장">
<meta name="keywords"
	content="충남 보령 무창포펜션, 무창포 해수욕장, 가족펜션, 객실개별바베큐, 수영장">
...
<!-- 서브 텍스트 -->
<script src="/resources/js/jquery.scrollmagic.min.js"
...
<<<<<<< HEAD
								<li class="gnb_2"><a href="#">객실안내</a>
									<div class="sub_menu">
										<ul class="depth2">
											<li class="first"><a href="#">데이지</a></li>
											<li><a href="#">릴리</a></li>
											<li><a href="#">아이비</a></li>
											<li><a href="#">마가렛</a></li>
=======
...
>>>>>>> 1f0f98dd0e5342c76be3fceb40d634c190492c74
									<div class="sub_menu">
										<ul class="depth2">
											...
											<li><a href="/question/listAll">질문과답변</a></li>
			...
			<div class="cts" id="main_cts">
				<div id="slides">
					<div class="data-1">
						...
						<div class="opa water02">
							신비의 바닷길과 추억을 무창포 이루펜션에서 만나보실 수 있습니다. <br />고품격의 여유로움속으로 당신을
							초대합니다.
						</div>
