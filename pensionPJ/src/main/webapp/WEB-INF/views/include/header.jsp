...
<body>
	...
	<div class="Web navi">
        <div class="navi_box">
            <h1><a href="/main/index"><img src="/resources/img/main/logo2.png" alt="J.P펜션" /></a></h1>  
                <div class="nav">
                    <div class="gnb">
                        <div class="gnb_wrap">
                                <ul class="depth1">
                                    <li class="gnb_1"><a href="/main/index">J.P펜션</a>
                                    <div class="sub_menu">
                                        <ul class="depth2">
		...
		<div class="cts" id="main_cts">
			<div id="slides">
				<div class="data-1">
                        ...
                        <div class="opa water02">신비의 바닷길과 추억을 무창포 J.P에서 만나보실 수 있습니다. <br />고품격의 여유로움속으로 당신을 초대합니다.</div>
                ...
                <div class="data-2">
                        <div class="opa water01"></div>
                        <div class="opa water0102"></div>
                        <div class="opa water02">신비의 바닷길과 추억을 무창포 J.P펜션에서 만나보실 수 있습니다. <br />고품격의 여유로움속으로 당신을 초대합니다.</div>
                        <div class="opa water03"><a href="/reservation/reservation_main">실시간예약</a></div>
                    <div class="opa prd"></div>
				</div>
                <div class="data-3">
