...
<link href="/resources/smartEditor/css/smart_editor2.css" rel="stylesheet" type="text/css">
<style type="text/css">
	body { margin: 10px; }
</style>
<script type="text/javascript" src="/resources/smartEditor/lib/jindo2.all.js" charset="utf-8"></script>
<script type="text/javascript" src="/resources/smartEditor/lib/jindo_component.js" charset="utf-8"></script>
<script type="text/javascript" src="/resources/smartEditor/SE2M_Configuration.js" charset="utf-8"></script>
<script type="text/javascript" src="/resources/smartEditor/SE2BasicCreator.js" charset="utf-8"></script>
<script type="text/javascript" src="/resources/smartEditor/smarteditor2.min.js" charset="utf-8"></script>

<!-- ì¬ì§ì²¨ë¶ìí  --> 
<script type="text/javascript" src="/resources/smartEditor/sample/js/plugin/hp_SE2M_AttachQuickPhoto.js" charset="utf-8"></script>
</head>
<body>
				...
				<li class="husky_seditor_ui_fontName"><button type="button" class="se2_font_family" title="ê¸ê¼´"><span class="husky_se2m_current_fontName">ê¸ê¼´</span></button>
					...
					<div class="se2_layer husky_se_fontName_layer">
						<div class="se2_in_layer">
							...
							<li><button type="button"><span>ëëë°ë¥¸ê³ ë<span>(</span><em style="font-family:'ëëë°ë¥¸ê³ ë',NanumBarunGothic,NanumBarunGothicOTF;">ê°ëë¤ë¼</em><span>)</span></span></button></li>
...
<div id="se2_sample" style="margin:10px 0;">
	...
	<input type="button" onclick="submitContents();" value="ìë²ë¡ ë´ì© ì ì¡" />
	...
	<form action="sample/viewer/index.php" method="post">
		<textarea name="ir1" id="ir1" rows="10" cols="100" style="width:766px; height:412px; display:none;">
			<p>ê¸ ìì ì ì¬ê¸°ì ê°ì ë£ì´ì£¼ë©´ ë©ëë¤.</p>
		</textarea>
	</form>
</div>
...
if(window.frameElement){
	...
	var oEditor = createSEditor2(jindo.$("ir1"), {
		...
		//aAdditionalFontList : [["MS UI Gothic", "MS UI Gothic"], ["Comic Sans MS", "Comic Sans MS"],["TEST","TEST"]],	// ì¶ê° ê¸ê¼´ ëª©ë¡
		fOnBeforeUnload : function(){
			//ìì  ì½ë
			//return "ë´ì©ì´ ë³ê²½ëììµëë¤.";
		}
	});
	...
	oEditor.run({
		fnOnAppReady: function(){
			//ìì  ì½ë
			//oEditor.exec("PASTE_HTML", ["ë¡ë©ì´ ìë£ë íì ë³¸ë¬¸ì ì½ìëë textìëë¤."]);
		}
	});
	...
	function submitContents() {
		oEditor.exec("UPDATE_CONTENTS_FIELD");	// ìëí°ì ë´ì©ì´ textareaì ì ì©ë©ëë¤.
