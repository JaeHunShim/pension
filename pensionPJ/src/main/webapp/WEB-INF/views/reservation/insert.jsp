...
<!-- //Sub Title -->
<!-- ../zzAppModule/design/pension/process/reser_info_process.php -->
<form name="frm" method="post" action="../zzAppModule/design/pension/process/reser_info_process.php" onsubmit="return reser_send()">
...
<div class="conT">
    ...
    <table border="0" cellpadding="0" cellspacing="1" class="wideT num">
      ...
      <tbody>
				<input type="hidden" name="room_code[]" value="1471309602">
				<input type="hidden" name="iprice[]" value="120000">
		...
		<input type="hidden" name="selDay" value="2018-6-7">
		<input type="hidden" name="code" value="1471309602">
		<input type="hidden" name="total_money" id="total_money" value="120000">
		<input type="hidden" name="sDay" value="1528333200">
		<input type="hidden" name="eDay" value="1528419600">
		<input type="hidden" name="reserInfo" value="1박 2일">
		<input type="hidden" name="total_service" id="total_service" value="">
