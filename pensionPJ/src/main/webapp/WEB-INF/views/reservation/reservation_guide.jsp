...
<section class="sub_con sub02" id="scene1">
    ...
    <div class="sub_txt box">
			<div class="info_box">
        <h3><img src="/resources/img/reservation/sst1.gif" alt="객실요금안내"></h3>
          <table width="100%" border="0" cellspacing="1" cellpadding="0" class="wideT num">
            ...
            <tr>
              ...
              <td>250,000원</td>
				        ...
				        <p align="center" style="padding:25px 0;"><a href="/reservation/calendar_skin"><img src="/resources/img/reservation/re_but.gif" /></a></p>
        <h3 style="padding-top:35px;"><img src="/resources/img/reservation/sst2.gif" alt="기본숙지사항"></h3>
        ...
        <h3 style="padding-top:35px;"><img src="/resources/img/reservation/sst3.gif" alt="고객유의사항"></h3>
           ...
           <h3 style="padding-top:35px;"><img src="/resources/img/reservation/sst4.gif" alt="환불규정"></h3>
            <ul class="list">
