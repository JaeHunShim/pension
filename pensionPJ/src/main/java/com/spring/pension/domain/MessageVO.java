...
public class MessageVO {
	...
	public String toString() {
		return "MessageVO [message_id=" + message_id + ", message_sender=" + message_sender + ", message_receiver="
				...
				+ ", unReadCount=" + unReadCount + ", getMessage_id()=" + getMessage_id() + ", getMessage_sender()="
				+ getMessage_sender() + ", getMessage_receiver()=" + getMessage_receiver() + ", getMessage_content()="
				+ getMessage_content() + ", getMessage_sendTime()=" + getMessage_sendTime() + ", getMessage_readTime()="
				+ getMessage_readTime() + ", getCHATROOM_chatroom_id()=" + getCHATROOM_chatroom_id()
				+ ", getUSER_user_id()=" + getUSER_user_id() + ", getTUTOR_USER_user_id()=" + getTUTOR_USER_user_id()
				+ ", getCLASS_class_id()=" + getCLASS_class_id() + ", getUser_profileImagePath()="
				+ getUser_profileImagePath() + ", getReceiver_user_profileImagePath()="
				+ getReceiver_user_profileImagePath() + ", getUser_name()=" + getUser_name()
				+ ", getReceiver_user_name()=" + getReceiver_user_name() + ", getClass_name()=" + getClass_name()
				+ ", getClass_id()=" + getClass_id() + ", getTUTOR_tutor_id()=" + getTUTOR_tutor_id()
				+ ", getTutor_name()=" + getTutor_name() + ", getTuti_id()=" + getTuti_id() + ", getUnReadCount()="
				+ getUnReadCount() + ", getClass()=" + getClass() + ", hashCode()=" + hashCode() + ", toString()="
				+ super.toString() + "]";
	}
