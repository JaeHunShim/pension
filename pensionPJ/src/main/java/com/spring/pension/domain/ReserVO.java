...
public class ReserVO {
	...
	public String toString() {
		return "ReserVO [user_id=" + user_id + ", user_name=" + user_name + ", room_name=" + room_name + ", total_pay="
				+ total_pay + ", inwon_check=" + inwon_check + ", fullDate=" + fullDate + ", lastFullDate="
				+ lastFullDate + ", reser_select=" + reser_select + ", entance_time=" + entance_time
				...
				+ getTotal_pay() + ", getInwon_check()=" + getInwon_check() + ", getFullDate()=" + getFullDate()
				+ ", getLastFullDate()=" + getLastFullDate() + ", getReser_select()=" + getReser_select()
